{ pkgs, ... }: {
  ...
  home.file = {
    ...
    ".config/pipewire/pipewire.conf" = {
      source = ./dotfiles/pipewire/pipewire.conf;
      recursive = true;
    };
    ...
    ".local/share/scriptdeps/emoji" = {
      source = ./dotfiles/emoji;
      recursive = true;
    };
    ...
    ".local/share/fonts/UniSans-Heavy.otf" = {
